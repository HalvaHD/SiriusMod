...
namespace Twig
{
	...
	public class CalamityIntegration
	{
		...
		public static void Unload()
		{
			...
			CalamityMod = null; // Make sure to null out any references to allow Garbage Collection to work.
		}
