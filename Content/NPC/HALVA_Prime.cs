...
namespace ProtoMod.Content.NPC
{
    ...
    public class HALVA_Prime : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            NPCID.Sets.AttackType[Type] = 2; // 0 = throwing, 1 = shooting, 2 = magic, 3 = melee
            NPCID.Sets.AttackTime[Type] = 60; 
            NPCID.Sets.AttackAverageChance[Type] = 15; // Lower numbers make the Town NPC appear more aggressive.
            ...
            NPC.Happiness
                ...
                .SetNPCAffection(ModContent.NPCType<KORRO>(), AffectionLevel.Love)
       ...
       public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        ...
        // Pre-Hardmode items (they disappear after Wall of Flesh)
                ...
                .Add(new Item(ItemID.StrangePlant1) { shopCustomPrice = Item.buyPrice(silver: 50) }, Condition.PreHardmode)// Hardmode items (they appear after WOF)
                ...
                .Add(new Item(ItemID.FallenStar, 10) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.Hardmode).Add(new Item(ItemID.LeafWings) { shopCustomPrice = Item.buyPrice(silver: 30) }, Condition.Hardmode)
