...
{
    internal class LightTwigProjectile : ModProjectile
    {
        ...
        {
            Projectile.CloneDefaults(ProjectileID.BatOfLight); // Copy the stats of the ZephyrFish
            AIType = ProjectileID.BatOfLight; // Mimic as the ZephyrFish during AI.
        ...
        {
            Lighting.AddLight(Projectile.Center, 1.255f, 1.255f, 1.255f);
            Player player = Main.player[Projectile.owner];

            // Keep the projectile from disappearing as long as the player isn't dead and has the pet buff.
            if (!player.dead && player.HasBuff(ModContent.BuffType<LightTwigBuff>()))
            {
