    ...
    internal class SlimeRProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            ...
            ProjectileID.Sets.CharacterPreviewAnimations[Projectile.type] = ProjectileID.Sets.SimpleLoop(1, 1, 1)
               .WhenNotSelected(0, 0).WithOffset(0f, 0f)
        ...
        {
            Projectile.CloneDefaults(ProjectileID.KingSlimePet); // Copy the stats of the ZephyrFish
            AIType = ProjectileID.KingSlimePet; // Mimic as the ZephyrFish during AI.
        ...
        public override void AI()
        {
            ...
            if (!player.dead && player.HasBuff(ModContent.BuffType<SlimeRBuff>()))
            {
