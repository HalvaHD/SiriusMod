...
namespace ProtoMod.Content.Items.Healing
{
    ...
    public class MedicinePipeFifthTier: ModItem
    {
        ...
        public static int HealAmount = 300;
        ...
        public override bool? UseItem(Player player)
        {
            ...
            MedicinePipeBuff.DamageInc = 0.115f;
            MedicinePipeBuff.FishingInc = 75;
        ...
        {
            CreateRecipe()
                .AddIngredient<MedicinePipeFourthTier>()
                .AddIngredient(ModContent.ItemType<OmegaHealingPotion>(), 25)
                .AddIngredient(ModContent.ItemType<StarBar>(), 45)
