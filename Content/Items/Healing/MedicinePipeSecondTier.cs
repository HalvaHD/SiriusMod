...
namespace Twig.Content.Items.Healing
{
    public class MedicinePipeSecondTier : ModItem
    {
        ...
        public override bool? UseItem(Player player)
        {
            ...
            MedicinePipeBuff.DamageInc = 0.055f;
            MedicinePipeBuff.FishingInc = 30;
        ...
        {
            CreateRecipe()
                .AddIngredient<MedicinePipe>()
                .AddIngredient(ItemID.GreaterHealingPotion, 25)
                .AddIngredient(ModContent.ItemType<StarBar>(), 5)
